    ...
    if (!initializationPromise) {
      initializationPromise = (async () => {
        try {
          ...
          const Prism = await import(
            /* webpackChunkName: "prism-core" */ "prismjs/components/prism-core"
          );
...
export const loadPrismLanguage = async (language: string): Promise<void> => {
  ...
  loadingPromises[language] = (async () => {
    try {
      ...
      switch (mappedLanguage) {
        case "jsx": {
          ...
          if (!window.Prism.languages.jsx) {
            window.Prism.languages.jsx = window.Prism.languages.extend(
              "markup",
              window.Prism.languages.javascript
            );
          }
        ...
        case "tsx": {
          ...
          if (window.Prism && !window.Prism.languages.tsx) {
            window.Prism.languages.tsx = window.Prism.languages.extend(
              "typescript",
              window.Prism.languages.jsx
            );
        ...
        case "typescript": {
          if (
            ...
            Object.keys(prism.languages.typescript).length === 0
          ) {
            await import("prismjs/components/prism-typescript");
          }
          break;
        ...
        case "python": {
          ...
          if (
            ...
            Object.keys(prism.languages.clike).length === 0
          ) {
            await import("prismjs/components/prism-clike");
          }
          await import("prismjs/components/prism-markup-templating");
        ...
        default:
          if (mappedLanguage !== "plaintext")
            try {
              ...
              await import(
                /* webpackChunkName: "prism-lang.[request]" */ `prismjs/components/prism-${mappedLanguage}`
              );
              if (!window.Prism?.languages?.[mappedLanguage]) {
                throw new Error(
                  `Language ${mappedLanguage} (${language}) failed to load`
                );
              }
            } catch (error) {
      ...
      console.error(
        `Failed to load language: ${mappedLanguage} (${language})`,
        error
      );
